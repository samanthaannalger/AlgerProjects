...
=======
) + geom_point(size=3) + labs(x = "# of Apiaries within 3 km", y = "% Prevalence of BQCV in Bumblebees") + coord_cartesian(ylim = c(0, 1), xlim = c(0, 10)) + theme_minimal(base_size = 17) + scale_y_continuous(labels = scales::percent) + scale_x_continuous(breaks=c(0:10))

>>>>>>> origin/master
plot1

=======
) + geom_point(size=3) + labs(x = "# of Apiaries within 3 km", y = "Prevalence of BQCV") + coord_cartesian(ylim = c(0, 1), xlim = c(0,10)) + theme_minimal(base_size = 17)
>>>>>>> parent of cc7a7da... made some changes to the code
```
